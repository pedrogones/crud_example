                        ...
                        <tr>
                            ...
                            <td  class="flex gap-2 px-4 py-4 text-sm whitespace-nowrap">
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ route('users.destroy', $user) }}" onclick="event.preventDefault(); document.getElementById('form-delete-{{ $user->id }}').submit()" title="Excluir" class="text-sm font-semibold leading-6 text-red-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
